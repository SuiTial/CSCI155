// This is used by General Crates, Inc. to claculate
...
int main()
{
  ...
  ofstream outputFile;
    ...
    // Promt the user for the crate's length, width, and height
  ...
  //Open a file named Crates.txt
  outputFile.open("Crates.txt");
  ...
  //Write the volume, cost, charge and profit to a file.
  ...
  outputFile.close();
  cout << "Data written to Crates.txt\n";
  return 0;
}
